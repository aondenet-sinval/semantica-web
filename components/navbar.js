...
const NavBar = () => {
  return(<>
    <header>
      <h1 className="w3-bar-block w3-transparent w3-large"><Image className="w3-margin-right w3-margin-left" alt="" src="/logoaondenet.png" width={36} height={36} />Sinval Gomes Desenvolvimento WEB - Prado BA</h1>
      <nav  role="navigation">
